...
setform({ ...form, [e.target.name]: e.target.value})
  ...
  return (
   <section className='max-w-7xl mx-auto'>
    ...
    Create as you wish : DALL-E AI does all the work for you!
    </p>
...
{generatingImg ? 'generating ... ' : 'Generate'}
    ...
    <div className=' mt-10'>
      <p className='mt-2 text-[#666e75] text-[14px]'>Want to share your generated images in the community?</p>
      <button 
      type='submit'
